<?php
		...
		$commentHTML .= '
			<div class="panel panel-primary">
				...
				<div class="panel-footer" align="right">
					<button type="button" class="btn btn-primary reply" id="'.$comment["id"].'">
						Reply
					</button>
				</div>
			</div> 
	...
	{
		$commentHTML = '';
		$commentQuery = "SELECT id, parent_id, comment, sender, date FROM comments WHERE parent_id = '".$parentId."'";	
